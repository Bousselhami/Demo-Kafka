...
import org.sid.DemoKafka.entities.PageEvent;
    ...
    public Flux<Map<String, Long>> analytics(@PathVariable String page){
        return Flux.interval(Duration.ofSeconds(1))
                .map(sequence->{
                    ...
                    Instant form=now.minusMillis(5000);
                    //KeyValueIterator<Windowed<String>, Long> fetchAll = windowStore.fetchAll(form, now);
                    WindowStoreIterator<Long> fetchAll=windowStore.fetch(page, form, now);
